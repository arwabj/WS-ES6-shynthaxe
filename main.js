...
// console.log(title.endsWith('Hill',26));
// console.log(title.endsWith('hill'));
// console.log(title.endsWith('Up', 19));
...
// console.log(`My name is: ${firstName}, My age is: ${age} and I am from ${city}`);
